<template>
  <div>
    ...
    <h1>Budget annuel assurance Santé</h1>
...
export default {
  ...
  setup() {
    ...
    return {
      prix,
      onSubmit() {
        const healthInsurancePrice = prix.value;
        store.dispatch('sante/setPrice', healthInsurancePrice);
      },
